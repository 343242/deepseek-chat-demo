...
class JsonExtractorUtilTest {
    ...
    class RawJson {
        ...
        void rawObject() {
            ...
            assertThat(JsonExtractorUtil.extractJson(json)).isEqualTo(json);
        }
        ...
        void leadingWhitespace() {
            String json = "  {\"key\": \"value\"}";
            assertThat(JsonExtractorUtil.extractJson(json)).isEqualTo("{\"key\": \"value\"}");
        }
    }
    ...
    class MarkdownCodeBlock {
        ...
        void extractMarkdownJson() {
            ...
            assertThat(JsonExtractorUtil.extractJson(input)).isEqualTo("{\"score\": 0.9}");
        }
        ...
        void extractMarkdownArray() {
            String input = "```json\n[{\"a\": 1}, {\"b\": 2}]\n```";
            assertThat(JsonExtractorUtil.extractJson(input)).isEqualTo("[{\"a\": 1}, {\"b\": 2}]");
        }
    }
    ...
    class EmbeddedJson {
        ...
        void extractEmbeddedObject() {
            ...
            assertThat(JsonExtractorUtil.extractJson(input)).isEqualTo("{\"key\": \"value\"}");
        }
        ...
        void extractEmbeddedArray() {
            ...
            assertThat(JsonExtractorUtil.extractJson(input)).isEqualTo("[0.8, 0.9, 0.7]");
        }
        ...
        void preferObjectOverArray() {
            ...
            assertThat(JsonExtractorUtil.extractJson(input)).isEqualTo("{\"a\": 1}");
        }
    }
    ...
    class EdgeCases {
        ...
        @DisplayName("null 输入")
        void nullInput() {
            assertThat(JsonExtractorUtil.extractJson(null)).isEqualTo("");
        }

        @Test
        @DisplayName("空字符串")
        void emptyInput() {
            assertThat(JsonExtractorUtil.extractJson("")).isEqualTo("");
        }

        @Test
        @DisplayName("纯文本无 JSON")
        void noJsonAtAll() {
            assertThat(JsonExtractorUtil.extractJson("just plain text")).isEqualTo("just plain text");
        }
    }
}
