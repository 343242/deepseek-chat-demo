...
class LouvainCommunityDetectorTest {
     ...
     * Standard 1-indexed edge list from Wayne W. Zachary, "An Information Flow Model for
     * Conflict and Fission in Small Groups," J. Anthropological Research 33, 452–473 (1977).
     * The two factions: node 1 = Mr. Hi (instructor), node 34 = John A. (officer/administrator).
     */
    private static void loadKarateClub(AdjacencyListGraph graph) {
        int[][] edges = {
            ...
            {17, 6}, {17, 7}, {18, 1}, {18, 2}, {18, 4}, {20, 1}, {20, 2},
            {22, 1}, {22, 2}, {26, 24}, {26, 25}, {28, 3}, {28, 24},
            {28, 25}, {29, 3}, {29, 24}, {30, 24}, {30, 27}, {31, 2},
            {31, 9}, {32, 1}, {32, 25}, {32, 26}, {32, 29}, {32, 30},
            {32, 31}, {33, 3}, {33, 9}, {33, 15}, {33, 16}, {33, 19},
            {33, 21}, {33, 23}, {33, 24}, {33, 25}, {33, 27}, {33, 28},
            {33, 29}, {33, 30}, {33, 31}, {33, 32}, {34, 9}, {34, 10},
            {34, 14}, {34, 15}, {34, 16}, {34, 19}, {34, 20}, {34, 21},
            {34, 23}, {34, 24}
        };
        for (var e : edges) {
